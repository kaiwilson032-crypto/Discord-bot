...
async def goose(interaction: discord.Interaction):
    ...
    # List of funny goose image URLs - actual goose/duck photos and gifs
    goose_images = [
        "https://media.giphy.com/media/39zbDQQUqV5wVMnMKW/giphy.gif",  # Angry goose
        "https://media.giphy.com/media/l3q2K5jinAlZ37S1i/giphy.gif",   # Aggressive goose
        "https://media.giphy.com/media/SvRuvlSFP6w0NvIkva/giphy.gif",  # Funny goose
        "https://media.giphy.com/media/GrUhLU9q3vyRG/giphy.gif",       # Goose dance
        "https://media.giphy.com/media/l0MeJkBrVzJvzMFpW/giphy.gif",   # Flying goose
        "https://media.giphy.com/media/3o6Zt6KHxJTbXCnSvu/giphy.gif",  # Happy goose
        "https://media.giphy.com/media/LXOoCKp8hnczPvsmRs/giphy.gif",  # Goose running
        "https://media.giphy.com/media/3ogwFGj3zPfv9nWroI/giphy.gif",  # Funny duck
        "https://media.giphy.com/media/l2JdY9dWJm8l7r6fS/giphy.gif",   # Duck waddle
        "https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif",   # Goose swim
        "https://media.giphy.com/media/ZXpLMLbBz5NYA/giphy.gif",       # Duck animation
        "https://media.giphy.com/media/l41YqKTQ0zOpAKwVS/giphy.gif",   # Honking goose
        "https://media.giphy.com/media/g9EgSjMlVAjfDp1d5v/giphy.gif",  # Silly goose
        "https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif",   # Goose friends
        "https://media.giphy.com/media/l2JdY9dWJm8l7r6fS/giphy.gif",   # Duck friends
        "https://images.unsplash.com/photo-1551447328-f4f2a3d06e50?w=600&q=80",  # Real goose photo
    ]
