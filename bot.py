...
async def goose(interaction: discord.Interaction):
    ...
    try:
        # List of goose image URLs
        goose_images = [
            "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Canada_Goose_%28John_Harthan%29.jpg/320px-Canada_Goose_%28John_Harthan%29.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Cackling_Goose_%28male%29.jpg/320px-Cackling_Goose_%28male%29.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/ChinaGoose.jpg/320px-ChinaGoose.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Brant_Goose_%28male%29.jpg/320px-Brant_Goose_%28male%29.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Snow_Goose_%28Chen_caerulescens%29_RWD.jpg/320px-Snow_Goose_%28Chen_caerulescens%29_RWD.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Greylag_goose_%28Anser_anser%29_RWD2.jpg/320px-Greylag_goose_%28Anser_anser%29_RWD2.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Branta_leucopsis_%28Barnacle_Goose%29.jpg/320px-Branta_leucopsis_%28Barnacle_Goose%29.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Anser_anser_domesticus_1.jpg/320px-Anser_anser_domesticus_1.jpg",
        ]
        ...
        await interaction.response.send_message(f"Error sending goose: {str(e)}", ephemeral=True)
