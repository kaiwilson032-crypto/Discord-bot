...
BANNED_WORDS = {
    ...
    # N-word variations - comprehensive coverage
    # Double-G forms (most common)
    ...
    # Single-G forms (common shortening)
    r'\bn[i!1]g[a3e4]r\b',
    ...
    # Just "Nig" or "Niga" or "Nige"
    r'\bn[i!1]g(?![a-z])\b',
    r'\bn[i!1]g[a3e4](?![a-z])\b',
    # With number substitutions for G (0, 6, 9)
    r'\bn[i!1][g60g9][g60g9][a3e4]r\b',
    r'\bn[i!1][g60g9][g60g9][a3e4]rs?\b',
    r'\bn[i!1][g60g9][g60g9][a3e4]rz?\b',
    r'\bn[i!1][g60g9][g60g9][a3e4]h\b',
    r'\bn[i!1][g60g9][g60g9][a3e4]ing\b',
    # Single G with number substitutions
    r'\bn[i!1][g60g9][a3e4]r\b',
    r'\bn[i!1][g60g9][a3e4]rs?\b',
    r'\bn[i!1][g60g9][a3e4]h\b',
    r'\bn[i!1][g60g9](?![a-z])\b',
    # With I substitutions (1, !, l, |)
    r'\bn[i!1l|][g60g9][g60g9][a3e4]r\b',
    r'\bn[i!1l|][g60g9][g60g9][a3e4]rs?\b',
    r'\bn[i!1l|][g60g9][a3e4]r\b',
    r'\bn[i!1l|][g60g9][a3e4]rs?\b',
    r'\bn[i!1l|]g[a3e4]r\b',
    r'\bn[i!1l|]gg[a3e4]r\b',
    r'\bn[i!1l|]gg[a3e4]h\b',
    # No vowel forms (just consonants)
    r'\bn[g60g9]g[a3e4]r\b',
    r'\bn[g60g9]g[a3e4]rs?\b',
    r'\bn[g60g9]g[a3e4]h\b',
...
async def goose(interaction: discord.Interaction):
    ...
    goose_images = [
        ...
        "https://media.giphy.com/media/GrUhLU9q3vyRG/giphy.gif",
        "https://media.giphy.com/media/l0MeJkBrVzJvzMFpW/giphy.gif",
        "https://media.giphy.com/media/3o6Zt6KHxJTbXCnSvu/giphy.gif",
        "https://media.giphy.com/media/LXOoCKp8hnczPvsmRs/giphy.gif",
        "https://media.giphy.com/media/3ogwFGj3zPfv9nWroI/giphy.gif",
        "https://media.giphy.com/media/l2JdY9dWJm8l7r6fS/giphy.gif",
        "https://media.giphy.com/media/l0MYt5jPR6QX5pnqM/giphy.gif",
        "https://media.giphy.com/media/ZXpLMLbBz5NYA/giphy.gif",
        "https://media.giphy.com/media/GrUhLU9q3vyRG/giphy.gif",
        "https://media.giphy.com/media/39zbDQQUqV5wVMnMKW/giphy.gif",
        "https://raw.githubusercontent.com/jmhobbs/cultofthepartyparrot.com/master/parrots/hd/shuffleparrot.gif",
        "https://media.giphy.com/media/l41YqKTQ0zOpAKwVS/giphy.gif",
        "https://media.giphy.com/media/g9EgSjMlVAjfDp1d5v/giphy.gif",
    ]
