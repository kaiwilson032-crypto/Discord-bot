...
async def on_message(message: discord.Message):
    ...
    if contains_banned_content(message.content):
        try:
            # Delete the message
...
@bot.tree.command(name="goose", description="Get a random funny goose image")
async def goose(interaction: discord.Interaction):
    """Send a random funny goose image"""
    
    # List of goose image URLs - actual goose photos ONLY (PNG/JPG, no ducks)
    goose_images = [
        "https://images.unsplash.com/photo-1551447328-f4f2a3d06e50?w=800&q=80",  # White goose
        "https://images.unsplash.com/photo-1551447328-e0b646a2cdfe?w=800&q=80",  # Goose walking
        "https://images.unsplash.com/photo-1570566174967-db51860a0ae1?w=800&q=80",  # Goose head
        "https://images.unsplash.com/photo-1552728473-29f4c42ff8e0?w=800&q=80",  # Swimming goose
        "https://images.unsplash.com/photo-1552574949-5bef17323295?w=800&q=80",  # Goose family
        "https://images.unsplash.com/photo-1550246188-47cafd846f38?w=800&q=80",  # Goose in water
        "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Greylag_goose_fighting_over_food.jpg/1200px-Greylag_goose_fighting_over_food.jpg",  # Greylag goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Anser_anser_domesticus_1.jpg/1200px-Anser_anser_domesticus_1.jpg",  # Domestic goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Greylag_goose_%28Anser_anser%29_RWD2.jpg/1200px-Greylag_goose_%28Anser_anser%29_RWD2.jpg",  # Wild goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/2/25/Canada_Goose_%28John_Harthan%29.jpg/1200px-Canada_Goose_%28John_Harthan%29.jpg",  # Canada goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Egyptian_Goose_%28Alopochen_aegyptiacus%29_%285166140234%29.jpg/1200px-Egyptian_Goose_%28Alopochen_aegyptiacus%29_%285166140234%29.jpg",  # Egyptian goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Branta_leucopsis_%28Barnacle_Goose%29.jpg/1200px-Branta_leucopsis_%28Barnacle_Goose%29.jpg",  # Barnacle goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f5/Cackling_Goose_%28male%29.jpg/1200px-Cackling_Goose_%28male%29.jpg",  # Cackling goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/ChinaGoose.jpg/1200px-ChinaGoose.jpg",  # Chinese goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Brant_Goose_%28male%29.jpg/1200px-Brant_Goose_%28male%29.jpg",  # Brant goose
        "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Snow_Goose_%28Chen_caerulescens%29_RWD.jpg/1200px-Snow_Goose_%28Chen_caerulescens%29_RWD.jpg",  # Snow goose
    ]
    
    import random
    random_goose = random.choice(goose_images)
    
    embed = discord.Embed(
        title="🦆 HONK HONK! 🦆",
        description="Here's a silly goose for you!",
        color=discord.Color.gold()
    )
    embed.set_image(url=random_goose)
    embed.set_footer(text="Goose image brought to you by the Goose Committee")
