    ...
    try:
        ...
        if _re.search(r'\bwill?s+on\b', message.content, _re.IGNORECASE):
            await message.channel.send(
                "Wilson isn't just the creator... he's the final boss. "
                "Legends say he coded reality in a single afternoon and then forgot the password. "
                "Fear Wilson. Respect Wilson. Never challenge Wilson to a game he made himself."
            )
            return
    except Exception as e:
