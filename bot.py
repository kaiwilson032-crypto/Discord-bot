...
BANNED_WORDS = {
    ...
    # N-word variations (base form and common obfuscations)
    r'\bn[i!1]gg[a3e]r\b',
    r'\bn[i!1]gg[a3e]rs?\b',
    r'\bn[i!1]gg[a3e]rz?\b',
    r'\bn[i!1]gg[a3e]ing\b',
    r'\bn[i!1]gg[a3e]ify\b',
    r'\bn[i!1]gg[a3e]fied\b',
    r'\bn[i!1]gg[a3e]hood\b',
    # Extended variations with additional substitutions (g=6, a=4, e=3)
    r'\bn[i!1][g6][g6][a3e4]r\b',
    r'\bn[i!1][g6][g6][a3e4]rs?\b',
    r'\bn[i!1][g6][g6][a3e4]rz?\b',
    r'\bn[i!1][g6][g6][a3e4]ing\b',
    r'\bn[i!1][g6][g6][a3e4]ify\b',
    r'\bn[i!1][g6][g6][a3e4]fied\b',
    r'\bn[i!1][g6][g6][a3e4]hood\b',
    # Hard A forms (historically used)
    r'\bn[i!1]gg[a4]h\b',
    r'\bn[i!1]gg[a4]hs?\b',
    r'\bn[i!1]gg[a4]hz?\b',
    # Alternative double-letter with number substitutions
    r'\bn[i!1][g6][g6][e3]r\b',
    r'\bn[i!1][g6][g6][e3]rs?\b',
    r'\bn[i!1][g6][g6][e3]rz?\b',
    r'\bn[i!1][g6][g6][a4][r5]\b',
    r'\bn[i!1][g6][g6][a4][r5]s?\b',
    r'\bn[i!1][g6][g6][a4][r5]z?\b',
...
async def goose(interaction: discord.Interaction):
    ...
    # List of funny goose image URLs from various sources
    goose_images = [
        ...
        "https://media.giphy.com/media/39zbDQQUqV5wVMnMKW/giphy.gif",
        "https://media.giphy.com/media/l3q2K5jinAlZ37S1i/giphy.gif",
        "https://media.giphy.com/media/SvRuvlSFP6w0NvIkva/giphy.gif",
        "https://images.unsplash.com/photo-1551447328-f4f2a3d06e50?w=600&q=80",
        "https://images.unsplash.com/photo-1551447328-e0b646a2cdfe?w=600&q=80",
        "https://images.unsplash.com/photo-1570566174967-db51860a0ae1?w=600&q=80",
        "https://images.unsplash.com/photo-1552728473-29f4c42ff8e0?w=600&q=80",
        "https://images.unsplash.com/photo-1606553895543-e11046813e2d?w=600&q=80",
        "https://images.unsplash.com/photo-1441974231531-c6227db76b6e?w=600&q=80",
        "https://images.unsplash.com/photo-1500462918059-b1a0cb1cbf72?w=600&q=80",
        "https://images.unsplash.com/photo-1444464666175-1642becfe3fb?w=600&q=80",
        "https://images.unsplash.com/photo-1552574949-5bef17323295?w=600&q=80",
        "https://images.unsplash.com/photo-1550246188-47cafd846f38?w=600&q=80",
        "https://images.unsplash.com/photo-1447004235497-a7842810e1f7?w=600&q=80",
        "https://cdn.download.ams.birds.cornell.edu/api/v1/asset/309477821/1800",
    ]
