...
@app_commands.describe(
    ...
    days="How many days? (optional)",
    hours="How many hours? (optional)",
    minutes="How many minutes? (optional)",
...
async def giveaway_start(
    ...
    """Start a new giveaway with flexible duration options"""
    ...
    try:
        ...
        if not minutes and not hours and not days:
            embed = discord.Embed(
                ...
                description="Please specify at least one: minutes, hours, or days.",
                color=discord.Color.red()
            )
            await interaction.followup.send(embed=embed, ephemeral=True)
            return
        ...
        total_minutes = (minutes or 0) + (hours or 0) * 60 + (days or 0) * 1440
